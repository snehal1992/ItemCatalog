...
#Item 1 
item1 = Item(name="Rimable Bamboo Drop", 
...
#Item2
item2 = Item(name="Rukket 6pc Baseball", 
...
#Item3
item3 = Item(name="12-Pack KEVENZ Green Advanced"+ 
...
#Item4
item4 = Item(name="adidas MLS Glider Soccer Ball", 
...
#Item5
item5 = Item(name="Senston - 2 Player Badminton" 
...
#Item6
item6 = Item(name="Puredrop Volleyball Training Equipment Aid", 
